...
export const SPORTS_CONFIG = [
  {
    ...
    programs: [
      {
        ...
        price: '$15/hr', tag: 'STARTER', img: '/tennis/tennis-girl-backhand.jpeg',
      },
      {
        ...
        price: '$20/hr', tag: 'POPULAR', img: '/tennis/tennis-coaching.jpeg',
      },
      {
        ...
        price: '$25/hr', tag: 'ELITE', img: '/tennis/tennis-player-serve.jpeg',
      },
    ],
    coaches: [
    ...
    pricing: [
      { name: 'Starter', price: 15, per: 'hr', features: ['2 sessions/week', 'Group training', 'Skill assessment', 'Court access', 'Community membership'], cta: 'GET STARTED' },
      { name: 'Pro', price: 20, per: 'hr', features: ['4 sessions/week', 'Small group format', 'Monthly report', 'Court access', '10% gear discount', 'WhatsApp coaching group'], cta: 'JOIN PRO', highlighted: true, badge: 'MOST POPULAR' },
      { name: 'Elite', price: 25, per: 'hr', features: ['Daily sessions', '1-on-1 coaching', 'Video analysis', 'Fitness conditioning', 'Tournament prep', '20% gear discount'], cta: 'GO ELITE' },
      { name: 'Private', price: 30, per: 'hr', features: ['1-on-1 with Coach Joseph', 'Flexible scheduling', 'Custom training plan', 'Video analysis', 'Tournament prep', '20% gear discount'], cta: 'BOOK PRIVATE' },
    ],
