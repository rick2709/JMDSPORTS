...
export const SPORTS_CONFIG = [
...

  {
    ...
    homeCardImg: 'https://images.unsplash.com/photo-1580748141549-71748dbe0bdc?w=800&q=80',
    ...
    heroImage: 'https://images.unsplash.com/photo-1580748141549-71748dbe0bdc?w=1400&q=80',
    programs: [
      {
        ...
        price: '$28/month', tag: 'STARTER', img: 'https://images.unsplash.com/photo-1615218988730-dc8f6b16c7e3?w=800&q=80',
      },
      {
        ...
        price: '$50/month', tag: 'POPULAR', img: 'https://images.unsplash.com/photo-1580748141549-71748dbe0bdc?w=800&q=80',
      },
      {
        title: 'Elite Hockey',
        ...
        price: '$85/month', tag: 'ELITE', img: 'https://images.unsplash.com/photo-1615218988730-dc8f6b16c7e3?w=800&q=80',
      },
    ],
    coaches: [
      { name: 'Coach Rudo Makoni', title: 'Head Hockey Coach', img: 'https://images.unsplash.com/photo-1580748141549-71748dbe0bdc?w=400&q=80', exp: '12+ years', bio: 'Former Zimbabwe national hockey team midfielder with 12+ years coaching experience at club and national level.' },
      { name: 'Coach Tafadzwa Gumbo', title: 'Defensive Specialist', img: 'https://images.unsplash.com/photo-1615218988730-dc8f6b16c7e3?w=400&q=80', exp: '7 years', bio: 'Specializes in defensive positioning and goalkeeper coaching, with a talent for building team chemistry.' },
      { name: 'Coach Patience Nyamadzawo', title: 'Youth & Development', img: 'https://images.unsplash.com/photo-1580748141549-71748dbe0bdc?w=401&q=80', exp: '9 years', bio: 'Dedicated to junior development, coaching over 150 young players across Harare and Bulawayo.' },
    ],
    pricing: [
    ...
    extraFields: [],
    featuredMerch: [
      { name: 'Grays GX5000 Hockey Stick', price: 65, condition: 'new', img: 'https://images.unsplash.com/photo-1580748141549-71748dbe0bdc?w=400&q=80' },
      { name: 'Adidas Hockey Shoes', price: 70, condition: 'new', img: 'https://images.unsplash.com/photo-1542291026-7eec264c27ff?w=400&q=80' },
      { name: 'Grays GX3000 Stick (2022)', price: 30, condition: 'preloved', img: 'https://images.unsplash.com/photo-1615218988730-dc8f6b16c7e3?w=400&q=80', conditionNote: 'Light surface scratches', conditionRating: 4 },
      { name: 'Hockey Shin Guards (M)', price: 10, condition: 'preloved', img: 'https://images.unsplash.com/photo-1580748141549-71748dbe0bdc?w=401&q=80', conditionNote: 'Used one season', conditionRating: 3 },
    ],
  },

  {
    ...
    homeCardImg: 'https://images.unsplash.com/photo-1530549387789-4c1017266635?w=800&q=80',
    ...
    heroImage: 'https://images.unsplash.com/photo-1530549387789-4c1017266635?w=1400&q=80',
    programs: [
      {
        ...
        price: '$32/month', tag: 'STARTER', img: 'https://images.unsplash.com/photo-1519315901367-f34ff9154487?w=800&q=80',
      },
      {
        ...
        price: '$58/month', tag: 'POPULAR', img: 'https://images.unsplash.com/photo-1530549387789-4c1017266635?w=800&q=80',
      },
      {
        ...
        price: '$95/month', tag: 'ELITE', img: 'https://images.unsplash.com/photo-1519315901367-f34ff9154487?w=800&q=80',
      },
    ],
    coaches: [
      { name: 'Coach Nyasha Banda', title: 'Head Swim Coach', img: 'https://images.unsplash.com/photo-1530549387789-4c1017266635?w=400&q=80', exp: '11 years', bio: 'Former Zimbabwean national swimmer with 11+ years coaching experience. Specializes in sprint events and technique correction.' },
      { name: 'Coach Chipo Mutasa', title: 'Youth Swim Specialist', img: 'https://images.unsplash.com/photo-1519315901367-f34ff9154487?w=400&q=80', exp: '6 years', bio: 'Dedicated to junior development. Chipo has introduced over 120 young swimmers to competitive aquatics.' },
      { name: 'Coach Farai Ncube', title: 'Performance & Race Coach', img: 'https://images.unsplash.com/photo-1530549387789-4c1017266635?w=401&q=80', exp: '9 years', bio: 'Former distance swimmer turned elite coach, specializing in race strategy and performance optimisation.' },
    ],
    pricing: [
    ...
    featuredMerch: [
      { name: 'Speedo Fastskin Goggles', price: 28, condition: 'new', img: 'https://images.unsplash.com/photo-1530549387789-4c1017266635?w=400&q=80' },
      { name: 'Arena Carbon Core Swimsuit', price: 55, condition: 'new', img: 'https://images.unsplash.com/photo-1519315901367-f34ff9154487?w=400&q=80' },
      { name: 'Arena Powerskin Suit (M)', price: 22, condition: 'preloved', img: 'https://images.unsplash.com/photo-1530549387789-4c1017266635?w=401&q=80', conditionNote: '5 competitions used', conditionRating: 4 },
      { name: 'Speedo Training Fins Size 8', price: 14, condition: 'preloved', img: 'https://images.unsplash.com/photo-1519315901367-f34ff9154487?w=401&q=80', conditionNote: 'Some scuff marks', conditionRating: 3 },
    ],
  },

  {
    ...
    homeCardImg: 'https://images.unsplash.com/photo-1549476464-37392f717541?w=800&q=80',
    ...
    heroImage: 'https://images.unsplash.com/photo-1549476464-37392f717541?w=1400&q=80',
    programs: [
      {
        ...
        price: '$25/month', tag: 'FITNESS', img: 'https://images.unsplash.com/photo-1544117519-31a4b719223d?w=800&q=80',
      },
      {
        ...
        price: '$48/month', tag: 'POPULAR', img: 'https://images.unsplash.com/photo-1549476464-37392f717541?w=800&q=80',
      },
      {
        ...
        price: '$80/month', tag: 'ELITE', img: 'https://images.unsplash.com/photo-1544117519-31a4b719223d?w=800&q=80',
      },
    ],
    coaches: [
      { name: 'Coach Tendai Moyo', title: 'Head Boxing Coach', img: 'https://images.unsplash.com/photo-1549476464-37392f717541?w=400&q=80', exp: '14 years', bio: "Former national amateur boxing champion, now one of Zimbabwe's most respected boxing coaches with 14+ years developing fighters." },
      { name: 'Coach Blessing Dube', title: 'Fitness & Conditioning', img: 'https://images.unsplash.com/photo-1544117519-31a4b719223d?w=400&q=80', exp: '8 years', bio: 'Specialist in boxing-specific fitness. Blessing designs conditioning programs that build explosive power and ring endurance.' },
      { name: 'Coach Grace Zimuto', title: 'Youth & Beginner Boxing', img: 'https://images.unsplash.com/photo-1549476464-37392f717541?w=401&q=80', exp: '5 years', bio: 'Focused on creating a safe, empowering boxing environment for beginners and young athletes aged 8–18.' },
    ],
    pricing: [
    ...
    featuredMerch: [
      { name: 'Everlast Pro Gloves 16oz', price: 48, condition: 'new', img: 'https://images.unsplash.com/photo-1549476464-37392f717541?w=400&q=80' },
      { name: 'Title Boxing Headgear', price: 55, condition: 'new', img: 'https://images.unsplash.com/photo-1544117519-31a4b719223d?w=400&q=80' },
      { name: 'Everlast 14oz Gloves', price: 22, condition: 'preloved', img: 'https://images.unsplash.com/photo-1549476464-37392f717541?w=401&q=80', conditionNote: 'Used 6 months, cleaned', conditionRating: 4 },
      { name: 'Boxing Headgear (M)', price: 20, condition: 'preloved', img: 'https://images.unsplash.com/photo-1544117519-31a4b719223d?w=401&q=80', conditionNote: 'Light padding wear', conditionRating: 3 },
    ],
  },
]
